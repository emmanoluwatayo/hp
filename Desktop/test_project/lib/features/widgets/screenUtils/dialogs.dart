...
class ScreenUtil {
  static void showLoadingView(BuildContext context) {
    Navigator.of(context).push(MzLoadingView());
  }
  ...
  static void showSuccessDialog(
    ...
    Navigator.of(context).push(
      MzSuccessDialog(message,
          buttonClicked: buttonClicked, buttonText: bottomContent!),
    );
  }
  ...
  static void showDialogForm(
    ...
    HapticFeedback.mediumImpact();
    Navigator.of(context).push(MzFormDialog(message,
        buttonClicked: buttonClicked, buttonText: buttonText));
  }
